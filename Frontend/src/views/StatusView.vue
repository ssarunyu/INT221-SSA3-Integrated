...
<template>
    ...
    <div class="w-full min-h-screen p-5">
        ...
        <div class="grid grid-cols-4 font-xl font-bold text-white border-b border-gray-300 p-3 bg-blue-400 rounded">
            <p>ID</p>
            <p>Name</p>
            <p>Description</p>
            <p>Action</p>
        ...
        <div class="space-y-5 mt-5">
            <div v-for="item in taskManagement.getAllStatus()" class="itbkk-item relative p-2 border rounded">
                <div class="grid grid-cols-4 items-center">
                    ...
                    <div class="itbkk-status-name font-medium text-lg px-4 mx-4 py-2 rounded break-all" :class=styleStatus(item.name)>
                        {{ item.name }}
                    </div>
