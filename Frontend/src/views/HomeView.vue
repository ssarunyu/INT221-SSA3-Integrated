...
console.log('is owner on homeview', isOwner.value)
</script>
        ...
        <div class="flex flex-col space-y-4 p-5">
            ...
            <div v-if="boardDetail">
                ...
                <div class="relative flex">
                    ...
                    <button
                        class="itbkk-board-visibility disabled disabled:cursor-not-allowed w-12 h-6 bg-gray-300 rounded-full cursor-pointer transition duration-200"
            ...
            <div class="w-full flex flex-col justify-center items-center space-y-5">
                ...
                class="itbkk-button-add disabled disabled:cursor-not-allowed w-full rounded-md p-5 bg-slate-200 text-slate-500 cursor-pointer duration-300 hover:bg-slate-300 hover:text-slate-700"
                :disabled="!isOwner"
                >
                    + Add New Task
                </button>
                    ...
                    <div>
                        <div class="dropdown itbkk-button-action">
                            ...
                            <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-white rounded-box w-40">
                                ...
                                <li>
                                    <button class="itbkk-button-edit disabled disabled:cursor-not-allowed"
                                ...
                                <li>
                                    <button class="itbkk-button-delete disabled disabled:cursor-not-allowed"
